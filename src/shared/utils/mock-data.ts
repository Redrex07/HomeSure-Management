...
export const properties = [
  {
    ...
    address: "412 Maple Ave, Austin TX",
    type: "Apartment",
    units: 1,
    status: "Occupied",
    rent: 2150,
  ...
  },
  {
    ...
    address: "88 Oak Ridge Rd, Denver CO",
    type: "House",
    units: 1,
    status: "Occupied",
    rent: 3200,
  ...
  },
  {
    ...
    address: "204 Birch Ln, Portland OR",
    type: "Townhouse",
    units: 1,
    status: "Occupied",
    rent: 2700,
    tenant: "Aaron Wu",
    landlord: "Linda Park",
    image: "https://images.unsplash.com/photo-1599809275671-b5942cabc7a2?w=600",
  },
  {
    id: "P-1047",
    name: "Cedar Heights #11",
    address: "11 Cedar Hts, Phoenix AZ",
    type: "Apartment",
    units: 1,
    status: "Listed",
    rent: 1950,
...
export const tenants = [
  ...
  },
  {
    ...
    phone: "(303) 555-0184",
    property: "Oakridge Single Family",
...
export const serviceRequests = [
  ...
  {
    id: "SR-9004",
    title: "Front lawn overgrown",
    property: "Birchwood Townhome",
    tenant: "Aaron Wu",
    category: "Landscaping",
    priority: "Low",
    status: "Completed",
    contractor: "GreenLeaf Landscaping",
    created: "2026-05-22",
    eta: "2026-05-26",
  },
  {
  ...
  {
    id: "SR-9006",
    title: "Replace front door lock",
    property: "Cedar Heights #11",
    tenant: "—",
    category: "Locksmith",
    priority: "Medium",
    status: "Assigned",
    contractor: "Lock & Key Pros",
    created: "2026-05-30",
    eta: "2026-06-03",
  },
  {
...
export const tickets = [
  {
    id: "TK-110",
    subject: "Cannot upload lease PDF",
    user: "Daniel Ortiz",
    role: "Landlord",
    priority: "Medium",
    status: "Open",
  ...
  {
    id: "TK-112",
    subject: "Add tax ID to invoice",
    user: "BlueLine Plumbing",
    role: "Contractor",
    priority: "Low",
    status: "Resolved",
    created: "2026-05-26",
  ...
  {
    id: "TK-113",
    subject: "Listing photos not saving",
    user: "Linda Park",
    role: "Realtor",
    priority: "Medium",
    status: "Open",
...
export const auditLogs = [
  {
    id: "L-001",
    time: "2026-06-01 09:22",
    actor: "jordan.r@homesure.app",
    action: "Assigned SR-9001 to BlueLine Plumbing",
    ip: "73.41.18.2",
  },
  {
    id: "L-002",
    time: "2026-06-01 08:51",
    actor: "daniel.o@homesure.app",
    action: "Updated rent on P-1042",
    ip: "98.221.4.10",
  },
  {
    id: "L-003",
    time: "2026-05-31 21:14",
    actor: "sarah.c@homesure.app",
    action: "Paid invoice INV-4501",
    ip: "184.22.8.55",
  },
  {
    id: "L-004",
    time: "2026-05-31 17:02",
    actor: "admin@homesure.app",
    action: "Suspended user U-099",
    ip: "10.0.4.7",
  },
  {
    id: "L-005",
    time: "2026-05-31 13:38",
    actor: "linda.p@homesure.app",
    action: "Published listing P-1047",
    ip: "67.88.91.4",
  },
];
...
export const notifications = [
  {
    ...
    body: "Marcus Hill opened SR-9003 — Bedroom outlet sparks",
    time: "12m ago",
    read: false,
    type: "service",
  },
  {
    id: "N-2",
    title: "Invoice paid",
    body: "INV-4501 was paid by Sarah Chen ($320)",
    time: "1h ago",
    read: false,
    type: "billing",
  },
  {
    ...
    body: "Cool Air HVAC estimate approved for $685",
    time: "3h ago",
    read: true,
    type: "service",
  },
  {
    ...
    body: "Marcus Hill lease ends in 90 days",
    time: "Yesterday",
    read: true,
    type: "lease",
  },
  {
    ...
    body: "Mia Thompson invited to Cedar Heights #11",
    time: "2d ago",
    read: true,
    type: "tenant",
  },
