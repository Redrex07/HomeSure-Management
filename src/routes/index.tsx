      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28">
          <div className="mx-auto max-w-3xl text-center">
            <Badge
              variant="outline"
              className="mb-6 gap-1.5 border-primary/30 bg-primary-soft text-primary"
            >
            ...
            <div className="mt-6 flex items-center justify-center gap-1.5 text-xs text-muted-foreground">
              <Check className="h-3.5 w-3.5 text-success" /> 14-day free trial · No credit card
              required
            </div>
          </div>
                ...
                <div className="grid gap-3 px-4 pb-4 sm:grid-cols-3">
                  <div className="col-span-2 h-40 rounded-lg border border-border bg-gradient-to-br from-primary-soft via-background to-info/5 p-3">
                    ...
                    <svg viewBox="0 0 400 120" className="mt-2 h-28 w-full">
                      ...
                      <path
                        d="M0,90 C50,80 80,60 120,55 C170,48 200,70 240,52 C290,30 320,20 400,12 L400,120 L0,120 Z"
                        fill="url(#g)"
                        className="text-primary"
                      />
                      <path
                        d="M0,90 C50,80 80,60 120,55 C170,48 200,70 240,52 C290,30 320,20 400,12"
                        fill="none"
                        strokeWidth="2"
                  ...
                  <div className="h-40 rounded-lg border border-border bg-card p-3">
                    ...
                    <ul className="mt-2 space-y-2 text-xs">
                      {[
                        "Leaking faucet · Maplewood",
                        "AC not cooling · Sunset",
                        "Outlet sparks · Oakridge",
                      ].map((t) => (
                        <li
                          key={t}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => (
              <Card
                key={f.title}
                className="border-border/70 transition-shadow hover:shadow-elegant"
              >
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {plans.map((p) => (
              <Card
                ...
                className={
                  p.popular
                    ? "relative border-primary/40 shadow-elegant ring-1 ring-primary/20"
                    : "border-border/70"
                }
              >
                {p.popular && (
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-6 space-y-2 text-sm">
              <div>
                <span className="font-medium text-foreground">Sales:</span> sales@homesure.app
              </div>
              <div>
                <span className="font-medium text-foreground">Support:</span> support@homesure.app
              </div>
              <div>
                <span className="font-medium text-foreground">Phone:</span> +1 (888) 555-HOME
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:grid-cols-4 sm:px-6">
          <div>
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              Modern property management & home warranty platform.
            </p>
          </div>
          <div>
